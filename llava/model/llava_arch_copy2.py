        ...
        if hasattr(config, "cache_load_way") and config.cache_load_way != None:
            try:
                ...
                self.background_cache = BackgroundFeatureCache(
                    # cache_dir=config.background_cache_dir if hasattr(config, 'background_cache_dir') else "~/background_feature_cache/test",
                    cache_dir="~/background_feature_cache/test",
