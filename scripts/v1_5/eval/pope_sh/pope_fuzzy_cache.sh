...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file $AUTO_DL_TMP/playground/data/eval/pope/answers/llava-v1.5-7b-fuzzy-cache-write.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file $AUTO_DL_TMP/playground/data/eval/pope/answers/llava-v1.5-7b-fuzzy-cache-read-load.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
...
python llava/eval/eval_pope.py \
    ...
    --question-file $AUTO_DL_TMP/playground/data/eval/pope/llava_pope_test.jsonl \
    --result-file $AUTO_DL_TMP/playground/data/eval/pope/answers/llava-v1.5-7b-fuzzy-cache-read-load.jsonl