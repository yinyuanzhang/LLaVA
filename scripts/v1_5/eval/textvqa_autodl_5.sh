...
python -m llava.eval.model_vqa_loader \
    ...
    --answers-file $AUTO_DL_TMP/playground/data/eval/textvqa/answers/windows-5.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1

python -m llava.eval.eval_textvqa \
    --annotation-file $AUTO_DL_TMP/playground/data/eval/textvqa/TextVQA_0.5.1_val.json \
    --result-file $AUTO_DL_TMP/playground/data/eval/textvqa/answers/windows-5.jsonl
