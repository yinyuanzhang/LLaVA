...
ANSWERS_FILE="$OUTPUT_DIR/finegym-llava-segmentation-cache-${TIMESTAMP}.json"
...
# --- Run LLaVA Inference (Segmentation Cache Method) ---
echo "Starting LLaVA inference on FineGym dataset using SEGMENTATION-CACHE method..."
