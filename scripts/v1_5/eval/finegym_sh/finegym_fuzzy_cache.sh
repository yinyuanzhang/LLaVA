...
ANSWERS_FILE="$OUTPUT_DIR/finegym-llava-fuzzy-cache-${TIMESTAMP}.json"
...
# --- Run LLaVA Inference (Fuzzy Cache Method) ---
echo "Starting LLaVA inference on FineGym dataset using FUZZY-CACHE method..."
