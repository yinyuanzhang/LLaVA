...
ANSWERS_FILE="$OUTPUT_DIR/finegym-llava-object-only-${TIMESTAMP}.json"
...
# --- Run LLaVA Inference (Object Only Method) ---
echo "Starting LLaVA inference on FineGym dataset using OBJECT-ONLY method..."
