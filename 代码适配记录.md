...
0
Left {valid.item()} tokens are mainly image background, right {576 - valid.item()} tokens are mainly image foreground


1
Left {valid.item()} tokens are mainly image background, right {576 - valid.item()} tokens are mainly image object.  中间


3
Left are mainly image background, right are mainly image object.  中间

4
First {valid.item()} image background tokens, then {576 - valid.item()} image foreground tokens.  开始

5 
First {valid.item()} image background tokens, then {576 - valid.item()} image foreground tokens. 末尾